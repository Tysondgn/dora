...
<body class="scroll-hide"
  style=" font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif ; font-size: 16px;">
  ...
  <?PHP if (isset ($_SESSION['table_number']) && isset ($_SESSION['indianDateTime'])) { ?>
    ...
    <header class="fixed-top d-lg-none" id="navbar">
      <nav class="navbar navbar-expand-lg navbar-dark p-0 pb-1 pt-1" style="background-color: #D2001A;">
        <div class="w-100 d-flex justify-content-between align-items-center">
          <!-- <img src="/examples/images/logo.svg" height="28" alt="Student's Corner"> -->
          <!-- <a href=""> -->
          <div class="fw-bold fst-italic text-white m-2 h3">Student's Corner</div>
          <!-- </a> -->
    ...
    <!-- Menu Item Cards -->
    <section class="d-lg-none scroll-hide" id="menu-card-id"
      style="margin-top: 100px; margin-bottom: 130px;">
        ...
        <?php while ($row = mysqli_fetch_array($result)) { ?>
          <div class="col-6 p-1 pb-3 <?php echo $row['category']; ?> d-flex justify-content-center">
            ...
            <a class="text-decoration-none" style="color: #000000"
              ...
              data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">
              <div data-aos="fade-up" class="card rounded shadow pb-2"
