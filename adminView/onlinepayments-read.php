...
//     $sql = mysqli_query($conn, "DELETE FROM OnlinePayments WHERE PaymentID = $paymentId");
//     echo "<script>alert('Data deleted');</script>";
//     echo "<script>window.location.href = 'onlinepayments-table.php'</script>";
// }
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-5">
                            <h2>Online Payments <b>Management</b></h2>
                        </div>
                ...
                <table class="table table-striped table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>Payment Status (Pending/Completed)</th>
                            <th>Transaction Date Time</th>
                            <th>Payment Method (Online/Counter)</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        $ret = mysqli_query($conn, "SELECT * FROM OnlinePayments");
                        $cnt = 1;
